...
export default function AIDraftEditor({ draftText, citations = [], onApply }) {
  const htmlContent = parseMarkdownToHtml(draftText || '');

  return (
    <div className="bg-white border-0 p-2">
      <div className="bg-indigo-50/50 rounded-lg p-4 border border-indigo-100 shadow-inner min-h-[120px] max-h-[400px] overflow-y-auto mb-4">
