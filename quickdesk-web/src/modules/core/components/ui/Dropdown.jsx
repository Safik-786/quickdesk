  ...
  return (
    <div className={`w-full relative ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        className={`
          relative w-full bg-white border rounded-lg pl-3.5 pr-10 py-2 text-left cursor-default 
          focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-colors
      ...
      {isOpen && (
        <div className="absolute z-10 mt-1 border border-slate-200 w-full bg-white shadow max-h-60 rounded-lg py-1 text-base ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
          {options.length === 0 ? (
